...
func (s *XMLSerializer) Serialize(writer io.Writer, baseDir string, filePaths []string, showTree bool) error {
...
func (s *XMLSerializer) readAndNormalizeContent(baseDir, relPath string) (string, error) {
