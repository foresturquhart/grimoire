...
func (s *PlainTextSerializer) Serialize(writer io.Writer, baseDir string, filePaths []string, showTree bool) error {
...
func (s *PlainTextSerializer) readAndNormalizeContent(baseDir, relPath string) (string, error) {
